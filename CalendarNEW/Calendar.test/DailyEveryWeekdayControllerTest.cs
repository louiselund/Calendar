    ...
    public class DailyEveryWeekdayControllerTest
    {
        ...
        public void PerformTest()
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                ...
                int i = 0;
                Console.WriteLine("The Result for dayli every weekday:");
                ...
                Assert.Equal(new DateTime(2015, 1, 2), dates[1]);
                Assert.Equal(new DateTime(2015, 1, 5), dates[2]);
                Assert.Equal(new DateTime(2015, 1, 6), dates[3]);
                Assert.Equal(new DateTime(2015, 1, 7), dates[4]);
                Assert.Equal(new DateTime(2015, 1, 8), dates[5]);
                Assert.Equal(new DateTime(2015, 1, 9), dates[6]);
